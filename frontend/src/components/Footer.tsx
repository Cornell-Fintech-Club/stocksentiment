    ...
    return (
        <div className="fixed inset-x-0 bottom-0">
            ...
            <aside className="items-center grid-flow-col">
                ...
                <p>Copyright Cornell FinTech © 2023 - All right reserved</p> {/* couldnt find logo svg, easy edit */}
            </aside> 
            <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
            <a href="https://www.cornellfintechclub.com/" className="text-white hover:text-blue-800">Website</a>
            <a href="https://www.instagram.com/cornellfintechclub/?hl=en" className="text-white hover:text-blue-800 ml-4">Instagram</a>
            <a href="https://twitter.com/cufintechclub" className="text-white hover:text-blue-800 ml-4">Twitter</a>
            <a href="https://www.linkedin.com/company/cornell-fintech-club/" className="text-white hover:text-blue-800 ml-4">LinkedIn</a>            </nav>
            </footer>
        </div>
    )
